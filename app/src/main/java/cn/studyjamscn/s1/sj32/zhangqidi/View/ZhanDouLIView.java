package cn.studyjamscn.s1.sj32.zhangqidi.View;
 ...
 */
public class ZhanDouLIView extends View {
    ...
    public ZhanDouLIView(Context context) {
        this(context,null);
    }

    public ZhanDouLIView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ZhanDouLIView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        rangePaint.setColor(Color.parseColor("#FF4081"));
        textPaint = new Paint();
